// /static/js/modules/supervisor-productos.js
document.addEventListener('DOMContentLoaded', function() {
    ...
    function cargarProductos() {
        fetch('/supervisor/api/productos')
    ...
    function cargarListasDesplegables() {
        // Cargar categorías
        fetch('/supervisor/api/productos/categorias')
            .then(response => response.json())
            .then(data => {
                categorias = data;
        ...
        // Cargar fabricantes
        fetch('/supervisor/api/productos/fabricantes')
            .then(response => response.json())
            .then(data => {
                fabricantes = data;
        ...
        fetch('/supervisor/api/productos/tipos-servicio')
            .then(response => response.json())
            .then(data => {
                tiposServicio = data;
        ...
        fetch('/supervisor/api/productos/tipos-fabricante')
            .then(response => response.json())
            .then(data => {
    ...
    function renderizarProductos() {
        ...
        productos.forEach(producto => {
            ...
            row.innerHTML = `
                ...
                <td>
                    <button class="btn btn-sm btn-warning" onclick="editarProducto(${producto.id_product})">
    ...
    window.editarProducto = function(id) {
        fetch(`/supervisor/api/productos/${id}`)
        .then(response => response.json())
        .then(producto => {
            ...
            // ELIMINAR ESTA LÍNEA: document.getElementById('idFabricante').value = producto.id_fabricante || '';
    ...
    function guardarProducto() {
        ...
        const data = {
            ...
            // Elimina esta línea: id_fabricante: document.getElementById('idFabricante').value,
        ...
        const url = id ? `/supervisor/api/productos/${id}` : '/supervisor/api/productos';
