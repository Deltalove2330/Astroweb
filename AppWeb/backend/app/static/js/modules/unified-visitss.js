...
function buildVisitCardsHtml(visits) {
    ...
    visits.forEach(function(v) {
        ...
        actions += `<button class="uv-action-btn uv-act-chat ${hasUnread?'uv-has-msgs':''}"
                        ...
                        onclick="event.stopPropagation();window.uaAbrirChatVisita(${v.id_visita}, ${v.id_cliente})"
...
function setupChatBadgeListener() {
    ...
    uvSocket.on('connect', function() {
        ...
        // ✅ CORRECTO: un único join a sala de notificaciones globales
        // NO hacemos join_chat por cada visita
