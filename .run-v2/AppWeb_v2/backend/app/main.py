...
# --- Local run: serve the prebuilt Angular SPA on the same origin (apiUrl is relative) ---
# Mounted LAST so all API routers and /docs take precedence over the static catch-all.
from fastapi.staticfiles import StaticFiles

_SPA_DIR = os.environ.get("SPA_DIR")
