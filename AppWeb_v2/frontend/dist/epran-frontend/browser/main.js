...
var roleGuard = (route) => {
  ...
  if (auth.canAccess(clave, requiredRoles))
    return true;
...
var routes = [
  ...
  {
    path: "login",
    loadComponent: () => import("./chunk-M36GJRLR.js").then((m) => m.LoginComponent)
  },
  {
    path: "login-mercaderista",
    loadComponent: () => import("./chunk-EMJHDMQR.js").then((m) => m.LoginMercaderistaComponent)
  },
  {
    path: "",
    canActivate: [authGuard],
    loadComponent: () => import("./chunk-J6ZM7LSB.js").then((m) => m.ShellComponent),
    children: [
      {
        path: "dashboard",
        loadComponent: () => import("./chunk-D6RLSYW3.js").then((m) => m.DashboardComponent)
      },
      {
        path: "centro-mando",
        loadComponent: () => import("./chunk-GAUPALG3.js").then((m) => m.CentroMandoComponent),
        canActivate: [roleGuard],
        data: { roles: ["admin", "superadmin", "analyst"] }
      },
      {
        path: "visits",
        loadComponent: () => import("./chunk-W7MP5TSA.js").then((m) => m.VisitsComponent)
      },
      {
        path: "routes",
        loadComponent: () => import("./chunk-GTTOOFOH.js").then((m) => m.RoutesComponent),
        canActivate: [roleGuard],
        data: { roles: ["admin", "analyst"] }
      },
      {
        path: "points",
        loadComponent: () => import("./chunk-FKYJCO2K.js").then((m) => m.PointsComponent)
      },
      {
        path: "photos",
        loadComponent: () => import("./chunk-ZPARLKHT.js").then((m) => m.PhotosComponent)
      },
      {
        path: "reports",
        loadComponent: () => import("./chunk-3XTQULGS.js").then((m) => m.ReportsComponent),
        canActivate: [roleGuard],
        data: { roles: ["admin"] }
      },
      {
        path: "users",
        loadComponent: () => import("./chunk-XWTWTH5S.js").then((m) => m.UsersComponent),
        canActivate: [roleGuard],
        data: { roles: ["admin"] }
      },
      {
        path: "client-categories",
        loadComponent: () => import("./chunk-LNPFKWQ4.js").then((m) => m.ClientCategoriesComponent),
        canActivate: [roleGuard],
        data: { roles: ["admin"] }
      },
      {
        path: "clientes-rutas",
        loadComponent: () => import("./chunk-3YOWB4UK.js").then((m) => m.ClientesRutasComponent),
        canActivate: [roleGuard],
        data: { roles: ["admin", "analyst"] }
      },
      {
        path: "permissions",
        loadComponent: () => import("./chunk-2NFPTRFS.js").then((m) => m.PermissionsComponent),
        canActivate: [roleGuard],
        data: { roles: ["admin"] }
      },
      {
        path: "sessions",
        loadComponent: () => import("./chunk-2YJRHIBY.js").then((m) => m.SessionsComponent),
        canActivate: [roleGuard],
        data: { roles: ["admin"] }
      },
      {
        path: "audit",
        loadComponent: () => import("./chunk-QEG6PGI7.js").then((m) => m.AuditLogComponent),
        canActivate: [roleGuard],
        data: { roles: ["admin"] }
      },
      {
        path: "chat",
        loadComponent: () => import("./chunk-CTVLY4Y3.js").then((m) => m.ChatComponent)
      },
      {
        path: "supervisor",
        loadComponent: () => import("./chunk-AILW5BVT.js").then((m) => m.SupervisorComponent),
        canActivate: [roleGuard],
        data: { roles: ["admin", "supervisor"] }
      },
      {
        path: "auditor",
        loadComponent: () => import("./chunk-V4BAK3PE.js").then((m) => m.AuditorComponent)
      },
      {
        path: "atencion-cliente",
        loadComponent: () => import("./chunk-ZLOERS2I.js").then((m) => m.AtencionClienteComponent),
        canActivate: [roleGuard],
      ...
      },
      {
        ...
        loadComponent: () => import("./chunk-XR5CAB5Y.js").then((m) => m.ClientPhotosComponent)
      },
      {
        path: "data",
        canActivate: [roleGuard],
        data: { roles: ["client", "coordinador_exclusivo", "admin", "analyst"] },
        loadComponent: () => import("./chunk-TQGNC5JB.js").then((m) => m.ClientDataComponent)
      },
      {
        path: "revision-visitas",
        canActivate: [roleGuard],
        data: { roles: ["admin", "analyst", "supervisor"] },
        loadComponent: () => import("./chunk-FZYD26CY.js").then((m) => m.RevisionVisitasComponent)
      },
      {
        path: "client",
        loadComponent: () => import("./chunk-XR5CAB5Y.js").then((m) => m.ClientPhotosComponent),
      ...
      {
        path: "client/visits",
        loadComponent: () => import("./chunk-UJSVRJUI.js").then((m) => m.ClientVisitsComponent),
        canActivate: [roleGuard],
        data: { roles: ["client", "coordinador_exclusivo"] }
      },
      {
        ...
        loadComponent: () => import("./chunk-AQW7IFU5.js").then((m) => m.MercaderistaComponent)
      },
      {
        path: "auditor-campo",
        canActivate: [roleGuard],
        data: { roles: ["auditor_campo", "admin"] },
        loadComponent: () => import("./chunk-UWM72QID.js").then((m) => m.AuditorCampoComponent)
      },
      {
        path: "products",
        loadComponent: () => import("./chunk-RELTGUNU.js").then((m) => m.ProductsComponent),
        canActivate: [roleGuard],
        data: { roles: ["admin", "atc"] }
      },
      {
        path: "data",
        loadComponent: () => import("./chunk-GD3QDWET.js").then((m) => m.DataComponent),
        canActivate: [roleGuard],
        data: { roles: ["admin", "analyst"] }
      },
      {
        path: "encuestador",
        loadChildren: () => import("./chunk-HKQJIGJD.js").then((m) => m.ENCUESTADOR_ROUTES),
        canActivate: [roleGuard],
        data: { roles: ["encuestador", "admin"] }
      },
      {
        path: "cliente-encuestador",
        loadChildren: () => import("./chunk-MKCUZPUO.js").then((m) => m.CLIENTE_ENCUESTADOR_ROUTES),
        canActivate: [roleGuard],
  ...
  {
    path: "unauthorized",
    loadComponent: () => import("./chunk-VZNV6TIJ.js").then((m) => m.UnauthorizedComponent)
  },
...
var authInterceptor = (req, next) => {
  ...
  return next(authReq).pipe(catchError((error) => {
    if (error.status === 401) {
      localStorage.removeItem("epran_token");
      router.navigateByUrl("/login");
    }
